...
public class UserRepository(AppDbContext context) : IUserRepository
{
    ...
    public async Task<User?> GetByResetPasswordTokenAsync(string token, CancellationToken ct = default)
        => await context.Users.FirstOrDefaultAsync(u => u.ResetPasswordToken == token, ct);
